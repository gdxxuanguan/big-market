...
import com.xuanguan.types.enums.ResponseCode;
import com.xuanguan.types.exception.AppException;
...
public class StrategyArmoryDispatch implements IStrategyArmory,IStrategyDispatch {
    ...
    public Integer getRandomAwardId(Long strategyId) {
        ...
        return repository.queryStrategyAwardAssemble(strategyId, new SecureRandom().nextInt(rateRange));
    }
